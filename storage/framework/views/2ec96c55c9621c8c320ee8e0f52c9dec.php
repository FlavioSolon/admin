    ...
    <div class="stars mb-3">
      <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <input
                ...
                class="star-<?php echo e($value); ?>"
            />
            <label class="star-<?php echo e($value); ?>" for="<?php echo e($uniqueId); ?>"></label>
...
<?php /**PATH /home/flaviosolon/code/nutricandies/admin/vendor/ibrahimbougaoua/filament-rating-star/src/../resources/views/form/components/rating-star.blade.php ENDPATH**/ ?>