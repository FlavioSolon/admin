...
<head>
    ...
    <title>Nova Solicitação à Ouvidoria - Nutricandies</title>
...
<div class="container">
    ...
    <div class="content">
        <h1>Olá, Equipe da Ouvidoria!</h1>
        <p>Recebemos uma nova solicitação na Ouvidoria da Nutricandies. Por favor, analise os detalhes abaixo e tome as providências necessárias.</p>

        <div class="details">
            <p><strong>Nome do Solicitante:</strong> {{ $data['name'] }}</p>
            <p><strong>E-mail para Contato:</strong> {{ $data['email'] }}</p>
            <p><strong>Canal:</strong> {{ \App\Enums\OmbudsmanChannel::from($data['channel'])->name }}</p>
